...
def _build_config() -> Form1120Config:
    direct_fields = {
        "company.name": f"{NAME}.f1_4[0]",
        "company.address.street": f"{NAME}.f1_5[0]",
        "company.address.suite": f"{NAME}.f1_6[0]",
        "company.address.city": f"{NAME}.f1_7[0]",
        "company.address.state": f"{NAME}.f1_8[0]",
        "company.address.country": f"{NAME}.f1_9[0]",
        "company.address.postal_code": f"{NAME}.f1_10[0]",
        "company.ein": f"{PAGE1}.f1_11[0]",
        "company.date_incorporated": f"{PAGE1}.f1_12[0]",
        "company.total_assets": f"{PAGE1}.f1_13[0]",
    ...
    for offset, path in enumerate(ordered_amount_paths, start=14):
        direct_fields[path] = f"{PAGE1}.f1_{offset}[0]"

    direct_fields.update(
        {
            "tax.total_tax": f"{PAGE1}.f1_48[0]",
            "tax.first_installment_section_1062": f"{PAGE1}.f1_49[0]",
            "tax.total_payments_and_credits": f"{PAGE1}.f1_50[0]",
            "tax.estimated_tax_penalty": f"{PAGE1}.f1_51[0]",
            "tax.amount_owed": f"{PAGE1}.f1_52[0]",
            "tax.overpayment": f"{PAGE1}.f1_53[0]",
            "tax.credit_to_next_year": f"{PAGE1}.f1_54[0]",
            "tax.refunded_amount": f"{PAGE1}.f1_55[0]",
            ...
            "schedule_j.refundable_credit_form_2439": "topmostSubform[0].Page3[0].Line20_ReadOrder[0].f3_41[0]",
            ...
            "schedule_j.section_1062_applicable_net_tax_liability": "topmostSubform[0].Page3[0].f3_47[0]",
            "schedule_j.total_payments_credits_and_section_1062": "topmostSubform[0].Page3[0].f3_48[0]",
            "schedule_k.cash_and_property_distributions_amount": "topmostSubform[0].Page5[0].IfYes_ReadOrder[0].f5_1[0]",
...
def resolve_friendly_1120_2025_values(values: dict[str, Any]) -> dict[str, Any]:
    return resolve_with_config(values, CONFIG_2025)
